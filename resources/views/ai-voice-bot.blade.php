                        ...
                        <div class="generation__page">
                            ...
                            <div class="generation_header">
                                <div class="header_top">
                                    <h1 class="title">Ses Dosyası Üret</h1>
                                </div>
                                <form>
                                    <div class="header_bottom">
                                        ...
                                        <div class="include_area">
                                            <select name="form-control" id="voice">
                                    ...
                                    <div class="fn__generation_item">
                                        <div class="item_header">
                                            <div class="title_holder">
                                                <h2 class="prompt_title">{{ $voice->promt }}</h2>
                                                <h2 class="prompt_title">Seslendiren: {{ $voice->answer }}</h2>
                                            </div>
                                            ...
                                            <ul class="fn__generation_list">
                                                <li class="fn__gl_item">
                                                    <div class="fn__gl__item">
                                                        <div class="abs_item">
                                                            <audio controls>
                                                                <source src="{{$voice->voice_name}}" type="audio/mpeg">
        ...
        $("form").submit(function(event) {
            ...
            $.ajax({
                ...
                $("#generation_history_first").append(
                    ...
                    '<h2 class="prompt_title">Seslendiren: ' + $("form #voice").val() + '</h2>' +
                    '</div>' +
                    '</div>' +
                    '<div class="item_list">' +
                    '<ul class="fn__generation_list">' +
